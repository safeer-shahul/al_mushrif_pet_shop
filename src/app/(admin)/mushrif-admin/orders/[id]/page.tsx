...
import { useCategoryService } from '@/services/admin/categoryService'; // To resolve image URLs
import { ProductImage } from '@/types/product'; // Import ProductImage for explicit typing
...
const AdminOrderDetailPage: React.FC = () => {
    ...
    const { getStorageUrl } = useCategoryService(); // For product images
    ...
    const getProductImage = useCallback((item: OrderItem) => {
        ...
        const safeParseImages = (rawImages: any): ProductImage[] => {
            // If it's a string like "[]", parse it. If it's null/undefined, return [].
            ...
            // If it's already an array or another type that evaluates truthy (but isn't string), cast it.
    ...
    const handleStatusUpdate = async (newStatus: string) => {
        ...
        try {
            ...
            // Re-fetch to get accurate inventory and date updates
            await loadOrder(); 
